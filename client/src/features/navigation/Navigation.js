        ...
        <div className='lg:flex lg:items-center lg:justify-between'>
          <div className='flex items-center justify-between'>
            <div className='text-xl font-semibold text-gray-700'>
              <button
                className='flex items-center text-2xl font-bold text-gray-800 transition-colors duration-300 transform dark:text-white lg:text-3xl hover:text-gray-700 dark:hover:text-gray-300'
                onClick={handleRootNavigate}
              >
                <InboxStackIcon className='w-7 lg:w-9 mr-2' />
                Goals
              </button>
            </div>
          ...
          >
            <div className='flex flex-col mx-6 lg:flex-row lg:items-center lg:mx-8'>
              <button className='px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'>
                Item One
              </button>
              <button className='px-3 py-2 mx-3 mt-2 text-gray-700 transition-colors duration-300 transform rounded-md lg:mt-0 dark:text-gray-200 hover:bg-gray-100 dark:hover:bg-gray-700'>
                Item Two
            ...
            <div className='flex items-center mt-4 lg:mt-0'>
              ...
              >
                ...
                <h3 className='mx-2 text-gray-700 dark:text-gray-200 lg:hidden'>User Name</h3>
              </button>
            </div>
          </div>
        </div>
