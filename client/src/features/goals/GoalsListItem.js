const GoalsListItem = () => (
  <div className='p-8 space-y-3 border-2 border-blue-400 dark:border-blue-300 rounded-xl'>
    ...
    <div className='flex items-center justify-end'>
      ...
      <button
        type='button'
        className='w-full px-4 py-2 mt-2 text-sm font-medium tracking-wide text-white capitalize transition-colors duration-300 transform bg-blue-500 rounded-md sm:w-auto sm:mt-0 hover:bg-blue-400 focus:bg-blue-400 focus:outline-none focus:ring focus:ring-blue-300 focus:ring-opacity-40'
      >
        Done
      </button>
    </div>
